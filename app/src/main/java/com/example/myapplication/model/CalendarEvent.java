...
public class CalendarEvent {
    ...
    public CalendarEvent(String n, String uid, int pay_rate, String begin, String end, String begin_time, String end_time, RepeatType repeated, int ID, AlarmType alarmType) {
        this.name = n;
        this.userId = uid;
